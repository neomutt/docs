...
The official documentation for [NeoMutt](https://neomutt.org), a
terminal-based email client. Built with [Sphinx](https://www.sphinx-doc.org/)
and hosted on [Read the Docs](https://readthedocs.org/).

[![Documentation Status](https://app.readthedocs.org/projects/neomutt-docs/badge/)](https://app.readthedocs.org/projects/neomutt-docs/builds/)

## Structure

The guide follows the [Diátaxis](https://diataxis.fr/) documentation
