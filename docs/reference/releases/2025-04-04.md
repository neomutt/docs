---
title: NeoMutt 20250404
description: Release notes for NeoMutt 20250404 with CLI improvements, bug fixes, and config dump enhancements.
keywords: neomutt, release, 20250404, changelog, bug fixes, cli, neomutt -DD, dump config, version, update
---
