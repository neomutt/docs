---
title: Attachment Menu Functions
description: Default key bindings and functions for the NeoMutt Attachment Menu.
keywords: neomutt, functions, attachment, menu, bindings, keys
---
