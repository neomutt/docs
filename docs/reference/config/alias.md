...
:::{note}
This also affects the entries of the address query menu, thus potentially overruling the order of entries as generated by [`$query_command`](cfg-query-command).
:::
