...
| [`$autocrypt`](#opt-autocrypt)                                         | Enables the Autocrypt feature                                               |
...
| [`$help`](#opt-help)                                                 | Display a help line with common key bindings                               |
...
| [`$history`](#opt-history)                                           | Number of history entries to keep in memory per category                   |
...
| Config Option                   | Description                                                                     |
|---------------------------------|---------------------------------------------------------------------------------|
| [`$keep_flagged`](keep-flagged) | Don't move flagged messages from [`$spool_file`](spool-file) to [`$mbox`](#opt-mbox) |
...
| [`$mbox`](#opt-mbox)                                               | Folder that receives read emails (see Move)                                                                  |
...
| [`$move`](move)                                               | Move emails from [`$spool_file`](spool-file) to [`$mbox`](#opt-mbox) when read                                    |
...
| Config Option                                                         | Description                                                                            |
|-----------------------------------------------------------------------|----------------------------------------------------------------------------------------|
| [`$pager`](#opt-pager)                                                     | External command for viewing messages, or empty to use NeoMutt's                       |
