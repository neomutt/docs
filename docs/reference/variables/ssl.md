...
option supersedes [`$ssl_starttls`](../index.md#ssl_starttls).
...
suppress the advertising of support.  Setting [`$ssl_force_tls`](../index.md#ssl_force_tls) is
...
`[`<account-hook>`](../index.md#account_hook)` function.
...
the `[`<account-hook>`](../index.md#account_hook)` function.
...
marked trusted (in [`$certificate_file`](../index.md#certificate_file)), without marking the root
