...
|---------|-----------------------|---------------------------------------|--------------|
| compose | [`<preview-page-down>`](fn-preview-page-down) | Show the next page of the message     | {kbd}`<PageDown>` |
| compose | [`<preview-page-up>`](fn-preview-page-up)   | Show the previous page of the message | {kbd}`<PageUp>`   |
