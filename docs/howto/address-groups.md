...
As soon as a group gets empty because all addresses and regular expressions have been removed, it will internally be removed, too (i.e. 
there cannot be an empty group). 
