...
program that comes with NeoMutt. By default they are stored under `~/.smime/`.
...
If you have told NeoMutt to S/MIME encrypt a message, it will guide you through
...
keys, you are prompted for a user ID. You can abort this prompt using `^G`,
and NeoMutt will return to the compose screen.
