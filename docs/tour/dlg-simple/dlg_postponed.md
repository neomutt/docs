...
dlg_postponed() MENU_POSTPONED - Postponed Email

postpone/dlg_postpone.c:240:6: dlg_postponed()
	menu_tagging_dispatcher()
	km_dokey(MENU_POSTPONED)
	km_dokey(MENU_GENERIC)
	postpone_function_dispatcher()
	menu_function_dispatcher()
	global_function_dispatcher()

MENU_POSTPONED - OpPostponed
	"exit"                        OP_EXIT
...
postpone/functions.c:175:22: postpone_function_dispatcher - PostponeFunctions[]
	OP_DELETE                           op_delete
	OP_EXIT                             op_exit
