...
dlg_history() MENU_DIALOG - History Selection

history/dlg_history.c:137:6: dlg_history()
...
history/functions.c:77:21: history_function_dispatcher - HistoryFunctions[]
