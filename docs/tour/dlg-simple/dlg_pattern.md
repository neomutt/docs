...
dlg_pattern() MENU_DIALOG - Pattern Selection

pattern/dlg_pattern.c:307:6: dlg_pattern()
...
pattern/functions.c:79:21: pattern_function_dispatcher - PatternFunctions[]
