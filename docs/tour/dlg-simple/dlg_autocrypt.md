...
dlg_autocrypt() MENU_AUTOCRYPT - Autocrypt Account

autocrypt/dlg_autocrypt.c:272:6: dlg_autocrypt()
	menu_tagging_dispatcher()
	km_dokey(MENU_AUTOCRYPT)
	km_dokey(MENU_GENERIC)
	autocrypt_function_dispatcher()
	menu_function_dispatcher()
	global_function_dispatcher()

MENU_AUTOCRYPT - OpAutocrypt
...
autocrypt/functions.c:212:23: autocrypt_function_dispatcher - AutocryptFunctions[]
